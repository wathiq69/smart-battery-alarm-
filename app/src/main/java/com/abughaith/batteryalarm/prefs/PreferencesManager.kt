...
class PreferencesManager private constructor(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_LAST_SPOKEN_PERCENT = "last_spoken_percent"
        private const val KEY_LAST_SPOKEN_CHARGING = "last_spoken_charging"
        private const val KEY_LOW_ALERT_SPOKEN_15 = "low_alert_15"
        private const val KEY_LOW_ALERT_SPOKEN_10 = "low_alert_10"
        private const val KEY_LOW_ALERT_SPOKEN_5 = "low_alert_5"
        private const val KEY_CHARGING_ANNOUNCED = "charging_announced"
    ...
    var lastSpokenPercent: Int
        get() = prefs.getInt(KEY_LAST_SPOKEN_PERCENT, -1)
        set(value) = prefs.edit().putInt(KEY_LAST_SPOKEN_PERCENT, value).apply()

    var lastSpokenCharging: Boolean
        get() = prefs.getBoolean(KEY_LAST_SPOKEN_CHARGING, false)
        set(value) = prefs.edit().putBoolean(KEY_LAST_SPOKEN_CHARGING, value).apply()

    var lowAlertSpoken15: Boolean
        get() = prefs.getBoolean(KEY_LOW_ALERT_SPOKEN_15, false)
        set(value) = prefs.edit().putBoolean(KEY_LOW_ALERT_SPOKEN_15, value).apply()

    var lowAlertSpoken10: Boolean
        get() = prefs.getBoolean(KEY_LOW_ALERT_SPOKEN_10, false)
        set(value) = prefs.edit().putBoolean(KEY_LOW_ALERT_SPOKEN_10, value).apply()

    var lowAlertSpoken5: Boolean
        get() = prefs.getBoolean(KEY_LOW_ALERT_SPOKEN_5, false)
        set(value) = prefs.edit().putBoolean(KEY_LOW_ALERT_SPOKEN_5, value).apply()

    var chargingAnnounced: Boolean
        get() = prefs.getBoolean(KEY_CHARGING_ANNOUNCED, false)
        set(value) = prefs.edit().putBoolean(KEY_CHARGING_ANNOUNCED, value).apply()

    fun resetLowAlertFlags() {
        prefs.edit()
            .putBoolean(KEY_LOW_ALERT_SPOKEN_15, false)
            .putBoolean(KEY_LOW_ALERT_SPOKEN_10, false)
            .putBoolean(KEY_LOW_ALERT_SPOKEN_5, false)
            .putBoolean(KEY_CHARGING_ANNOUNCED, false)
            .apply()
    }
}
