...
class AppUsageAdapter(
    ...
    companion object {
        val DIFF = object : DiffUtil.ItemCallback<AppUsageManager.AppInfo>() {
            override fun areItemsTheSame(a: AppUsageManager.AppInfo, b: AppUsageManager.AppInfo) =
                a.packageName == b.packageName
            override fun areContentsTheSame(a: AppUsageManager.AppInfo, b: AppUsageManager.AppInfo) =
                a == b
        }
    }
